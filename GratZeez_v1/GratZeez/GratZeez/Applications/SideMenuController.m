...
- (id)initWithCoder:(NSCoder *)aDecoder {
	...
	if (self) {
		_options = [[SideMenuOptions alloc] init];
	}
...
- (id)initWithMenuViewController:(UIViewController *)menuViewController
	...
	return [self initWithMenuViewController:menuViewController
					  contentViewController:contentViewController
									options:[[SideMenuOptions alloc] init]];
}
...
-(void)addrightMenuButtonWithImage:(UIImage *)buttonImage{
    UIImage* image3 = buttonImage;
    CGRect frameimg = CGRectMake(0, 0, image3.size.width, image3.size.height);
    UIButton *someButton = [[UIButton alloc] initWithFrame:frameimg];
    [someButton setBackgroundImage:image3 forState:UIControlStateNormal];
    [someButton addTarget:self action:@selector(toggleMenu:)
...
- (void)addLeftMenuButtonWithImage:(UIImage *)buttonImage {
	...
	UIBarButtonItem *menuButton = [[UIBarButtonItem alloc] initWithCustomView:someButton ] ;// style:UIBarButtonItemStylePlain target:self action:@selector(toggleMenu)];
